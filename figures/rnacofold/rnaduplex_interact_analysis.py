"""
Exon-intron interaction analysis using RNAduplex MFE.

For each of the 4 chunks, split exons into bottom 2% MFE (strongest/most stable
duplex) vs rest, then compare:
  - Mean residual PSI  (signed residual jitter boxplot)
  - Variance of residual PSI  (Levene bar chart)
"""
...
duplex = pd.read_csv(BASE / "data/test_rnaduplex_interact.csv")
...
# ── Fig 1: Mean residual PSI (4 panels) ──────────────────────────────────────
...
fig1.suptitle("RNAduplex MFE — mean residual PSI: bottom 2% vs rest", fontsize=10)
fig1.tight_layout()
p1 = OUT / "rnaduplex_interact_signed_residual.png"
fig1.savefig(p1, dpi=150, bbox_inches="tight")
plt.close()
print(f"\nSaved {p1.name}")

# ── Fig 2: Variance of residual PSI (4 panels) ───────────────────────────────
...
fig2.suptitle("RNAduplex MFE — residual PSI variance: bottom 2% vs rest", fontsize=10)
fig2.tight_layout()
p2 = OUT / "rnaduplex_interact_psi_variance.png"
