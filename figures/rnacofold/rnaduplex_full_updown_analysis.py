"""
Exon-intron interaction analysis: full upstream (150bp) and downstream (100bp).

Bottom 2% MFE vs rest for:
  - Mean residual PSI (jitter boxplot)
...
duplex = pd.read_csv(BASE / "data/test_rnaduplex_full_updown.csv")
...
for chunk in CHUNKS:
    ...
    print(f"{chunk:<12} {thr:>10.1f} {len(bot):>7}  "
...
fig1.suptitle("RNAduplex — mean residual PSI: bottom 2% vs rest\n"
              "(full upstream 150bp, full downstream 100bp)",
              fontsize=10, y=1.02)
fig1.tight_layout()
p1 = OUT / "rnaduplex_full_updown_signed_residual.png"
...
fig2.suptitle("RNAduplex — residual PSI variance: bottom 2% vs rest\n"
              "(full upstream 150bp, full downstream 100bp)",
              fontsize=10, y=1.02)
fig2.tight_layout()
p2 = OUT / "rnaduplex_full_updown_psi_variance.png"
