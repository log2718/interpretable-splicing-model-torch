...
parser.add_argument("--out-dir", default=str(Path(__file__).resolve().parent),
                    help="Directory containing act_incl.npy / act_skip.npy / oh_array.npy "
                         "and where output figures are saved.")
...
# To regenerate: run generate_kmer_activations.py with --out-dir matching this.
